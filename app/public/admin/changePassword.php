            ...
            <div class="wrap-login100">
                ...
                <form method="post" action="" onsubmit="return validate()">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Password không được bỏ trống!">
                        <input class="input100 inputpass" type="password" placeholder="Mật khẩu cũ" name="current-password" id="password-field">
                        ...
                        <input class="input100 inputpass" type="password" placeholder="Xác nhận lại mật khẩu mới" name="confirm-new-password" id="password-field3">
